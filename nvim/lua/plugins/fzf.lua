return {
    ...
    config = function ()
		...
		vim.keymap.set('n', '<leader>fB', fzf.lines, { desc = 'Fzf lines in all open buffers' })
		vim.keymap.set('n', '<leader>fj', fzf.jumps, { desc = 'Fzf jumplist' })
		vim.keymap.set('n', '<leader>fm', fzf.marks, { desc = 'Fzf marks' })
		vim.keymap.set('n', '<leader>fo', function() require('config.mru').pick() end, { desc = 'Fzf recently opened files' })
